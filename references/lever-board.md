...
**Local-search caveat:** a Google Business Profile is a local-search tool. If the business is global or remote, a location-verified profile signals the wrong market, and virtual addresses get suspended. Decide once, record the reasoning, do not relitigate.
